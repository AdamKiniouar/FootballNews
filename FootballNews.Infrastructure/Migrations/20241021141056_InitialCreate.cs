        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FetchDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@example.com", "$2a$11$0pL.t0u4WbJ.dBmfQAvRLerzH5VNow5dd1QXh0BmMC7HIxwH1RCE.", "Admin" });
